...
provider "proxmox" {
  ...
  pm_api_token_secret = "a8c740bc-e036-4b17-964a-8bc323a05964"
...
resource "proxmox_vm_qemu" "tf_server" {
  ...
  # be *.*.*.91 since count.index starts at 0. this is how you can create
